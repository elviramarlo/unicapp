...
exports.addLicenseToDmgOld = addLicenseToDmgOld;
...
async function addLicenseToDmg(packager, dmgPath) {
  ...
  for (const button of licenseButtonFiles) {
    ...
    const label = filepath.endsWith(".yml") ? (0, _jsYaml().safeLoad)(await (0, _fsExtra().readFile)(filepath, "utf-8")) : await (0, _fsExtra().readJson)(filepath);
...
async function addLicenseToDmgOld(packager, dmgPath) {
