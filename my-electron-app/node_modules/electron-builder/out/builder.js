...
function createTargets(platforms, type, arch) {
  ...
  for (const platform of platforms) {
    const archs = arch === "all" ? platform === _appBuilderLib().Platform.MAC ? [_builderUtil().Arch.x64, _builderUtil().Arch.arm64] : [_builderUtil().Arch.x64, _builderUtil().Arch.ia32] : [(0, _builderUtil().archFromString)(arch == null ? process.arch : arch)];
